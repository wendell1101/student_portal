 <div class="am-header">
      <div class="am-header-left">
        ...
        <a href="dashboard.php" class="am-logo">Curricular Portal for University of Rizal System Binangonan Campus</a>
      </div><!-- am-header-left -->
  ...
  ?>
                ...
                <div class="media pd-x-20 pd-y-15">
                  ...
                  <div class="media-body">
                    <p class="tx-13 mg-b-0"><strong class="tx-medium">New Application: <?php echo $row->StudentNum;?></strong><label style="color: green;padding-left: 10px"> <?php echo $row->FullName;?></label></p>
