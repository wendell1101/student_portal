...
if (strlen($_SESSION['cpfursbid']==0)) {
  ...
  $sql="update tbluser set FirstName=:fname,LastName=:lname,Address=:address where ID=:uid";
...
{               ?>
              ...
              <div class="row mg-t-20">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" name="fname" value="<?php  echo $row->LastName;?>" required="true" />
                </div>
              </div><!-- row -->
              ...
              <div class="row mg-t-20">
                ...
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" readonly="true" value="<?php  echo $row->StudentNum;?>" />
                </div>
              </div>
              <div class="row mg-t-20">
              ...
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">College: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" readonly="true" value="<?php  echo $row->College;?>" />
                </div>
              </div>
              <div class="row mg-t-20">
                <label class="col-sm-4 form-control-label">Course: <span class="tx-danger">*</span></label>
                <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                  <input type="text" class="form-control" readonly="true" value="<?php  echo $row->Course;?>" />
                </div>
              </div>
               <div class="row mg-t-20">
